    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>Form Upload <br> Galeri Sekolah </h3>
            </div>
            ...
            <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form action="{{url('/guru/tambah_galeri')}}" method="POST" enctype="multipart/form-data">@method('post') @csrf

                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align" name="image"
                                    id="image">Gambar
                                </label>
