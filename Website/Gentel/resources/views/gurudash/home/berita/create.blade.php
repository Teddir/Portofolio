        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form action="/guru/tambah_berita" method="post" enctype="multipart/form-data">@csrf 
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align" name="name_berita" id="name_berita">Berita
                                    Name 
                                </label>
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="name_berita" name="name_berita" required="required" class="form-control ">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class=" col-md-5 col-sm-10 " rows="3">
                                    <textarea class="resizable_textarea form-control"
                                        placeholder="isi berita" name="keterangan" id="keterangan"></textarea>
                                </div>
                            </div>
