    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>Form Upload <br> Kalender Pendidikan </h3>
            </div>
            ...
            <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form action="{{url('/guru/tambah_kalender')}}" method="POST" enctype="multipart/form-data">@method('post') @csrf

                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align" name="kalender_pendidikan"
                                    id="kalender_pendidikan">Gambar

                                </label>
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="file" id="kalender_pendidikan" name="kalender_pendidikan" required="required"
                                        class="form-control ">
