        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form action="/guru/tambah_artikel" method="post" enctype="multipart/form-data">@csrf 
                            <div class="item form-group">
                                <label class="col-form-label col-md-3 col-sm-3 label-align" name="name_artikel" id="name_artikel">Artikel
                                    Name 
                                </label>
                                <div class="col-md-6 col-sm-6 ">
                                    <input type="text" id="name_artikel" name="name_artikel" required="required" class="form-control ">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class=" col-md-5 col-sm-10 " rows="3">
                                    <textarea class="resizable_textarea form-control"
                                        placeholder="isi artikel" name="keterangan" id="keterangan"></textarea>
                                </div>
                            </div>
