...
<head>
    ...
    <!-- Custom CSS -->
    <link href="{{asset('cssq/style.min.css')}}" rel="stylesheet">
</head>
...
<body>
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <a class="navbar-brand" href="dashboard.html">
                        ...
                        <b class="logo-icon">
                            <!-- Dark Logo icon -->
                            <img src="{{asset('plugins/images/DASHBOARD.png')}}" alt="homepage" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="/siswa/profile"
                                aria-expanded="false">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="/siswa/persyaratan"
                                aria-expanded="false">
                                <i class="fa fa-table" aria-hidden="true"></i>
                                <span class="hide-menu">Syarat Wajib</span>
                            </a>
                        </li>
    ...
    <script src="{{asset('jsq/app-style-switcher.js')}}"></script>
    <script src="{{asset('plugins/bower_components/jquery-sparkline/jquery.sparkline.min.js')}}"></script>
    <!--Wave Effects -->
    <script src="{{asset('jsq/waves.js')}}"></script>
    <!--Menu sidebar -->
    <script src="{{asset('jsq/sidebarmenu.js')}}"></script>
    <!--Custom JavaScript -->
    <script src="{{asset('jsq/custom.js')}}"></script>
    ...
    <script src="{{asset('jsq/pages/dashboards/dashboard1.js')}}"></script>
</body>
